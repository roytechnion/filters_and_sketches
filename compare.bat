...
FOR %%H IN (hash-compare.txt nitrohash-compare.txt CMS-compare.txt NitroCMS-compare.txt Cuckoo-compare.txt NitroCuckoo-compare.txt SpaceSaving-compare.txt SpaceSaving-rap-compare.txt) do ECHO "" > %%H
