...
FOR %%H IN (hash-write.txt nitrohash-write.txt CMS-write.txt NitroCMS-write.txt Cuckoo-write.txt NitroCuckoo-write.txt SpaceSaving-write.txt SpaceSaving-rap-write.txt) do ECHO "" > %%H
