...
FOR %%H IN (hash-read.txt nitrohash-read.txt CMS-read.txt NitroCMS-read.txt Cuckoo-read.txt NitroCuckoo-read.txt SpaceSaving-read.txt SpaceSaving-rap-read.txt) do ECHO "" > %%H
